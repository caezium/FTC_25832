...
public class Localizer2802{
    ...
    public static double Ly = 157.113;
    public static double Ry = -180.86;
    public static double Bx = 10.235;
    ...
    public void initialize(HardwareMap map){
        ...
        podR = hardwareMap.get(DcMotor.class, "motorR");
        podL = hardwareMap.get(DcMotor.class, "motorL");
