...
public class TestLower extends LinearOpMode {
    ...
    public void runOpMode() {
        part1 = hardwareMap.get(ServoImplEx.class, control.servo(3));
        part2 = hardwareMap.get(ServoImplEx.class, control.servo(4));
        //part3 = hardwareMap.get(ServoImplEx.class, control.servo(5));
        ...
        while(opModeIsActive()){
            ...
            part2.setPosition(gamepad1.right_trigger);
